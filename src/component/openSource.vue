    ...
    <div class="relative">
        <div class="mx-auto max-w-md text-center sm:max-w-3xl lg:max-w-7xl">
            ...
            <p class="mt-5 max-w-prose mx-auto text-gray-400 text-md">
                I actively maintain many PHP, JavaScript & GO repositories and
                have contributed to many others, such as Laravel.
            </p>
                    ...
                    <div class="pt-6" v-for="project in Projects">
                        <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                            <div class="-mt-6">
                                <div>
                                    <span
                                        class="inline-flex items-center justify-center p-3 bg-pink-500 rounded-md shadow-lg"
                                    >
                                        <svg
