<template>
	<div class="relative lg:py-24">
		<div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
			...
			<p class="mt-5 max-w-prose mx-auto text-gray-400 text-sm">
			...
			<div class="mt-12">
                ...
                <span class="inline-flex items-center justify-center p-3 bg-white rounded-md shadow-lg">
                  ...
                  <svg class="h-6 w-6 text-pink-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
